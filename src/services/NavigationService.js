...
export async function getDirections(destination) {
  ...
  const url = `https://maps.googleapis.com/maps/api/directions/json?origin=${origin.coords.latitude},${origin.coords.longitude}&destination=${destination}&key=${GOOGLE_MAPS_API_KEY}`;
...
// Call this when user misses a turn (simulated or via GPS deviation)
